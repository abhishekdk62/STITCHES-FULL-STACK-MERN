...
export default function OrderSummary({ setStep, setCouponData, couponData }) {
  ...
  const discount = couponData
    ? ((cartItems?.totalPrice + cartItems?.tax) * couponData?.discountValue) /
      100
    : 0;
  const finalTotal =
  ...
  const handleApplyCoupon = async () => {
    ...
    if (finalTotal < 500) {
      return setErr('Minimum total amount to appply coupon is 500  ');
    }
    ...
    >
                                ...
                                <div className="flex text-sm justify-between">
                                  ...
                                  <div className="flex flex-col items-end">
                                    <div className="text-xs text-gray-700 mt-1">
                                      {daysUntilExpiry(coupon.expiryDate)} days
                                      left
                                    </div>
                                  </div>
                                </div>
      ...
      <div className="flex justify-between items-center border-b pb-4 mb-8">
        <div className="flex items-center gap-3">
          ...
          <h2 className="sm:text-2xl font-bold text-black tracking-tight">
            Order Summary
          </h2>
        </div>
      </div>
            ...
            <div className="flex items-start gap-3">
              <div>
                ...
                <p className="text-gray-700 text:xs sm:text-base mt-2 flex items-center gap-2">
                  ...
                  <p className="text:sm sm:text-base">{address?.phone}</p>
                </p>
              </div>
            </div>
            <motion.button
        ...
        <div className="space-y-3 bg-gray-50 p-6 rounded-lg border border-gray-100">
          <div className="flex justify-between text-gray-700">
            ...
            <p className="text-sm sm:text-base">
              ₹{cartItems?.totalPrice?.toFixed(2) || '0.00'}
            </p>
          </div>
          <div className="flex justify-between text-gray-700">
            <div className="flex items-center gap-2">
            ...
            <p className="text-sm sm:text-base">
              ₹{cartItems?.shippingPrice?.toFixed(2) || '0.00'}
            </p>
          </div>
          <div className="flex justify-between text-gray-700">
            <p className="text-sm sm:text-base">Tax</p>
            <p className="text-sm sm:text-base">
              ₹{cartItems?.tax?.toFixed(2) || '0.00'}
            </p>
          </div>
          {discount ? (
            <div className="flex justify-between text-gray-700">
          ...
          <div className="flex justify-between font-bold text-lg">
            ...
            <p className="text-[0.88rem] sm:text-base">
