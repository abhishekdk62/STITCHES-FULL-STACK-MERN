  ...
  return (
    <div className="relative bg-white">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className={
                !isAuthenticated|| !userDetails?.profileImage? "p-2 cursor-pointer rounded-full bg-black text-white hover:bg-gray-800 transition-all duration-300 hover:scale-110 transform"
      ...
      <nav className="flex items-center justify-center p-4 bg-white text-black">
        ...
        >
          {["SHOP", "MEN", "WOMEN", "COMBOS", "KIDS"].map((category) => (
            <button
              key={category}
              onClick={() =>
