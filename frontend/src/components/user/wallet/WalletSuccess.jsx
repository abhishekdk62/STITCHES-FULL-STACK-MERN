...
export default function WallSuccess() {
    ...
    <div className="flex items-center w-full  justify-center h-130 bg-gray-100">
      <div className="w-full max-w-md p-8 bg-white">
        <div className="flex flex-col items-center">
          ...
          >
            <button
              className="px-4 py-2 text-sm font-medium text-gray-700 border border-gray-300  hover:bg-gray-50 flex-1"
              onClick={viewOrder}
            >
              VIEW WALLET
            </button>
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-white  bg-black hover:bg-black flex-1"
            >
              CONTINUE SHOPPING
            </button>
          </motion.div>
