  ...
  return (
    <div className="w-full mx-auto bg-white p-8 rounded-lg shadow-lg border border-gray-100">
      ...
      <div className="flex justify-between items-center mb-8 pb-4 border-b border-gray-200">
        ...
        <button onClick={() => setShowAddCategory(false)} className="text-gray-400 hover:text-gray-700 transition-colors">
          <X size={24} />
        </button>
      </div>
      ...
      {notification.show && (
        <div className={`mb-4 p-3 rounded-md flex items-center ${
          ...
          {notification.type === "error" ? <AlertCircle className="mr-2" size={18} /> : <Check className="mr-2" size={18} />}
