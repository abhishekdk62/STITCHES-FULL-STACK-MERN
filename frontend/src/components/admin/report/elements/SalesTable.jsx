        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {salesReportData.deliveredItems.map((i, index) => (
              <tr key={index} className="hover:bg-gray-50">
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{i.createdAt.split("T")[0]}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{formatCurrency(
          ...
          <tfoot className="bg-gray-50">
            <tr>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900">{formatCurrency(totalPrice)}</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900">{ordersCount}</td>
              {selectedFilters.showDiscount && (
