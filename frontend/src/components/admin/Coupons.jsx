...
import { Lightbulb,Tag ,Edit2,Edit,Eye,Search,RefreshCw,Plus,Trash2,ArrowLeft,ArrowRight} from "lucide-react";
  ...
  return (
    <div>
      {selectedTab === "add" ? (
        ...
        <Coupon setSelectedTab={setSelectedTab} />
      ) : null}
    </div>
  );
};
            ...
            <div className="w-full md:w-auto flex flex-col md:flex-row items-center gap-4">
              <div className="relative w-full md:w-80">
                ...
                <input
                  ...
                  onKeyPress={(e) => e.key === 'Enter' && fetchCoupon(search.trim(), 1)}
                />
                {search && (
                  <button
                    onClick={() => {
              ...
              <button
                onClick={() => fetchCoupon(search.trim(), 1)}
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          {loading ? (
              ...
              <table className="w-full">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    ...
                    <th className="p-3 text-left font-medium text-gray-600">Limit</th>
                    <th className="p-3 text-left font-medium text-gray-600">Used</th>
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-gray-500">Try adjusting your search criteria or create a new coupon.</p>
            </div>
          )}
        </div>
...
const EditCoupon = ({ setSelectedTab }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const data = await editCoupon(coupon._id, updateData);
      console.log(data);
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-xl border border-gray-100">
      <div className="mb-6 border-b pb-4 flex items-center">
        <Edit className="text-gray-700 mr-3" size={24} />
        <div>
...
const RemovedCoupons = ({ setSelectedTab }) => {
  ...
  const handleRestore = async (id) => {
      ...
      try {
        ...
        console.log(error.response?.data || "An error occurred during restoration");
      }
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          {loading ? (
            ...
            <div className="p-8 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-1">No removed coupons found</h3>
              <p className="text-gray-500">Try adjusting your search criteria or check active coupons.</p>
            </div>
          )}
        </div>
